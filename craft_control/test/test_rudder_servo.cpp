...
using craft_control::CMD_MY_ITFS;
using craft_control::control_mode_type;
using craft_control::STATE_MY_ITFS;

class RudderServoTest : public RudderServoFixture<TestableRudderServo>
{
};

TEST_F(RudderServoTest, all_parameters_set_configure_success)
{
  SetUpController();
...
TEST_F(RudderServoTest, check_exported_intefaces)
{
  SetUpController();
...
TEST_F(RudderServoTest, activate_success)
{
  SetUpController();
...
TEST_F(RudderServoTest, update_success)
{
  SetUpController();
...
TEST_F(RudderServoTest, deactivate_success)
{
  SetUpController();
...
TEST_F(RudderServoTest, reactivate_success)
{
  SetUpController();
...
TEST_F(RudderServoTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(RudderServoTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(RudderServoTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(RudderServoTest, publish_status_success)
{
  SetUpController();
...
TEST_F(RudderServoTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
